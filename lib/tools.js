module.exports = {
  ...
  routeForwardAndBackAction: (router)=> {
    const handleRouteChange = () => {
      document.getElementById('history_back_button').classList.remove("opacity-50")
      document.getElementById('history_back_button').classList.replace("cursor-not-allowed","cursor-pointer")
    }
